...
# for running grub install
# I've had to do it too many times that this is worth it
export GRUB_MODULES="normal test efi_gop efi_uga search echo linux all_video gfxmenu gfxterm_background gfxterm_menu gfxterm loadenv configfile tpm font"
...
path=('/home/neven/.juliaup/bin' $path)
export PATH
...
alias mrover="source ~/.mrover.zsh"

# for hyprland invisible cursor issue
export WLR_NO_HARDWARE_CURSORS=1

# for sway to stop flickering
